		...
		acf_add_local_field_group(
			array(
				...
				'fields'          => array(
					...
					array(
						'key'          => 'field_trip_description',
						'label'        => 'Описание',
						'name'         => 'trip_description',
						'type'         => 'textarea',
						'rows'         => 4,
						'new_lines'    => '',
						'instructions' => 'Кратко описание за hero секцията на страницата.',
					),
					array(
						'key'           => 'field_trip_hero',
